...
const yoloService = require('./services/yoloLiveService'); // Updated to use live service
...
app.get('/api/yolo/classes', async (req, res) => {
  try {
    ...
    res.json({
      ...
      totalClasses: modelInfo.numClasses,
      description: 'COCO dataset classes (80 classes) - Live Detection'
    });
  } catch (error) {
...
app.listen(PORT, async () => {
  ...
  console.log('🔄 Initializing YOLO v8 live model...');
  try {
