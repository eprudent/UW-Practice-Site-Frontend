...
app.post('/api/claude/analyze', async (req, res) => {
  try {
    const { code } = req.body;
    const response = await claudeService.analyzeCode(code);
    res.json(response);
  } catch (error) {
...
app.post('/api/claude/refactor', async (req, res) => {
  try {
    const { code } = req.body;
    const response = await claudeService.refactorCode(code);
    res.json(response);
  } catch (error) {
    console.error('Claude code refactoring error:', error);
    res.status(500).json({ error: error.message });
  }
});
...
app.post('/api/codex/explain', async (req, res) => {
  try {
    const { code } = req.body;
    const response = await codexService.explainCode(code);
    res.json(response);
  } catch (error) {
    console.error('Codex code explanation error:', error);
    res.status(500).json({ error: error.message });
  }
});
...
app.post('/api/codex/debug', async (req, res) => {
  try {
    const { code } = req.body;
    const response = await codexService.debugCode(code);
    res.json(response);
  } catch (error) {
    console.error('Codex code debugging error:', error);
    res.status(500).json({ error: error.message });
  }
});
...
app.post('/api/codex/optimize', async (req, res) => {
  try {
    const { code } = req.body;
    const response = await codexService.optimizeCode(code);
    res.json(response);
  } catch (error) {
    console.error('Codex code optimization error:', error);
    res.status(500).json({ error: error.message });
  }
});
